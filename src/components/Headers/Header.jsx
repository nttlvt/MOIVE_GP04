        ...
        <div className="header__top">
            <div className="header__top--content flex gap-36">
                <a className="logo" href="/">
                    <img width={130} height={130} src="https://cinestar.com.vn/_next/image/?url=%2Fassets%2Fimages%2Fheader-logo.png&w=1920&q=75" alt="" />
                </a>

                <div className="order flex mt-5">
                    <Button className='flex font-bold' style={{backgroundColor: '#F3EA28', border: 'none', height: '40px', lineHeight: '32px'}} >
                        <img src="https://cinestar.com.vn/assets/images/ic-ticket.svg" className='mr-2 mt-1' alt="" />
                        <a className=''>ĐẶT VÉ NGAY</a>
                    </Button>
                    <Button className='flex ml-2 font-bold text-white' style={{backgroundColor: '#663399', border: 'none', height: '40px', lineHeight: '32px'}}>
                        <img src="" alt="" />
                ...
                <div className="header__top--right flex gap-10">
                    <Input  placeholder="Tìm phim, rạp" style={{cursor: 'pointer', height: '40px', width: '250px', marginTop: '20px', borderRadius: '50px'}}
                    ...
                    <Popover className='text-white flex gap-2 mt-5' content = {
                        <div className='flex gap-2' style={{ width: '60px', marginTop: '-4px' }}>
                            <img src="https://cinestar.com.vn/assets/images/footer-america.png" style={{width: "24px", height: "24px"}} alt="" />
                            <span className='flex gap-2 text-white'>
                                <p className=''>ENG</p>
                            </span>
                        </div>
                    }
                        overlayClassName="re-custom-popover"
                        placement="bottom"  
                        // trigger={'click'}
                    >
                        <div className='mt-[30px]'>
                            ...
                            <span className='flex gap-2'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" height="16" width="14"><path fill='#fff' d="M182.6 470.6c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-9.2-9.2-11.9-22.9-6.9-34.9s16.6-19.8 29.6-19.8H288c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9l-128 128z" /></svg>
                            </span>
                        </div>
                    </Popover>
                </div>
        ...
        <div className="header__bot flex gap-[520px] pb-6 font-bold">
            <div className="header__bot--left flex gap-9">
                <div className='text-white flex mt-5'>
                    ...
                    <Popover
                        content = {
                            <div className='flex gap-56 text-white font-bold' style={{width: '1190px'}}>
